...
public class Client {
    ...
    public static String addXOREncryption(String stringToEncrypt) {
    ...
    public static String takeOffXOREncryption(String stringToTakeOffEncrypt) {
    ...
    private static void checkMessage(String incomingMessage, SocketChannel socketChannel) {
        ...
        if (incomingMessage.contains(":*%*%_phase_0_*%%*:")) {
            ...
            try {
                ...
                log.info("Problem in Client, encryption phase: _0_");
            }
            ...
            try {
                ...
                log.info("Problem in Client, encryption phase: _1_");
            }
